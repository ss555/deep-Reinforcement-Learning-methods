...
class SAC_Trainer(object):
    ...
    def __init__(self, params):
        ...
        self.params['batch_size_initial'] = self.params['batch_size_initial']
...
def main():
    ...
    parser.add_argument('--batch_size_initial', '-ib', type=int, default=768) #steps collected per ini train iteration
    ...
    parser.add_argument('--buffer_size', type=int, default=100000)#self.agent_params['buffer_size']
