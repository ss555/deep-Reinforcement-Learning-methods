...
class RL_Trainer(object):
    ...
    def __init__(self, params):
        '''
        The keys of the params dictionary in the RL_Trainer class are:
        logdir
        seed
        no_gpu
        which_gpu
    ...
    def train_agent(self):
        # TODO: get this from previous HW
        all_logs=[]
        for tr_step in range(self.params['num_agent_train_steps_per_iter']):
